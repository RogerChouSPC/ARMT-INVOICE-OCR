      ...
      <div className="max-w-screen-2xl mx-auto px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-base font-medium text-gray-800 leading-tight">Invoice OCR</h1>
              <p className="text-xs text-gray-500 leading-tight">ARMT — Thai Invoice Extractor</p>
            </div>
          </div>
